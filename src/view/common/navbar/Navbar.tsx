...
const discoverItemDescriptions: Record<string, string> = {
    "intro": "Poprog помогает описывать управляющую программу как набор понятных процессов: так проще спроектировать логику, проверить её и перенести решение в реальное оборудование.",
