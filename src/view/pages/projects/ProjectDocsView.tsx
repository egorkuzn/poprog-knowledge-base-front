    ...
    reflex: {
        ...
        sections: [
            ...
            },
            {
                ...
                bullets: ["научные публикации по Reflex", "студенческие работы и демонстрационные проекты", "видеоматериалы и ответы ИИ-чата"]
            }
        ],
        links: coreLinks
    },
    ...
    "industrial-c": {
        ...
        sections: [
            ...
            },
            {
                ...
                bullets: ["искать материалы по IndustrialC", "задать вопрос ИИ-чату", "перейти к общему каталогу проектов"]
            }
        ],
        links: coreLinks
    }
